...
if (strpos($currentLocation, 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR) !== false) {
	$relativeLocation = 'app' . DIRECTORY_SEPARATOR . 'code' . DIRECTORY_SEPARATOR . 'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_ACF';
	...
	if (strpos($currentLocation, $relativeLocation) === false) {
		throw new \Exception(sprintf(
			...
			"FishPig_WordPress_ACF",
			$relativeLocation,
			'FishPig' . DIRECTORY_SEPARATOR . 'WordPress_ACF'
		));
	}
}
