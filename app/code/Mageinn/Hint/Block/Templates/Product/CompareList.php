...
class CompareList
{
     ...
     * @return string
     */
    public function afterGetTemplate(\Magento\Catalog\Block\Product\Compare\ListCompare $subject, $result)
    {
        return $this->helper->getTemplateName($this->helper->getTemplateCompare(), $result);
    }
}
